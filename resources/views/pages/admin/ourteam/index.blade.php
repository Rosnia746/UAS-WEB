                ...
                <div class="card">
                    <div class="card-header ">
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="{{ route('ourteam.create') }}" class="btn btn-primary">Create</a>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="text-right">
                                                        ...
                                                        <a
                                                            onclick="return confirm('Yakin untuk menghapus ourteam {{$item->title}}? ')">
                                                            <form action="{{ route('ourteam.destroy', $item->id) }}"
