    ...
    <div class="container-fluid">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Edit ourteam</h3>
            </div>
            @if ($errors->any())
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form method="post" action="{{ route('ourteam.update', $item->id) }}" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="job_position" class="form-control" id="job_position" placeholder="Enter Job Position"value="{{$item->job_position}}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="about" id="about" class="form-control" rows="5">{{$item->about}}</textarea>
                    </div>
                    <div class="form-group">
